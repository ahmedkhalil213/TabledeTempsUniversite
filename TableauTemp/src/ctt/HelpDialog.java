...
//////-------------------    
//content p7//
String TEXTp7="<h1>Modification pour projet Developpement à base de logiciel libre par <h1> <h4>Ahmed Khalil<h4>";
JEditorPane EDITORp7 = new JEditorPane("text/html",TEXTp7);
EDITORp7.setEditable(false);
p1.setLayout(new BorderLayout());
